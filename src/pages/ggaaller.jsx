  ...
  return (
    <div className="bg-white font-sans leading-normal tracking-normal">
      <div className="carousel relative shadow-2xl bg-white">
        <div className="carousel-inner relative overflow-hidden w-2/3">
          {/* Slide 1 */}
          <input
          ...
          <div
            ...
            style={{ height: "75vh" }}
          >
            <div className="block h-full w-full bg-yellow-500 text-white text-5xl text-center">
              Slide 1
            </div>
          </div>
          <label
            htmlFor="carousel-3"
            className="prev control-1 w-10 h-10 ml-2 md:ml-10 absolute cursor-pointer hidden text-3xl font-bold text-black hover:text-white rounded-full bg-white hover:bg-yellow-500 leading-tight text-center z-10 inset-y-0 left-0 my-auto"
          >
            ‹
          </label>
          <label
